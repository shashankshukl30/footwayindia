...
export function ProductCard({ product, inventoryCount }: ProductCardProps) {
  ...
  return (
    <>
          ...
          <div className="relative aspect-[4/5] overflow-hidden bg-brand-surface">
            ...
            <div className="absolute inset-x-0 bottom-0 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out">
              <button
                ...
                className="w-full bg-[#0F0F0E] text-white py-3 text-[10px] font-medium uppercase tracking-[0.25em] flex items-center justify-center gap-2 hover:bg-brand-gold transition-colors duration-200"
      ...
      {/* Quick View Modal — rendered at this level so it's outside the Link */}
      <QuickViewModal
